     ...
     <div className='flex justify-between items-center gap-4 p-2'>
        <Button
          ...
          className={ cn(
            ...
            isFilterFullOpen && "bg-primary-700 text-primary-100"
          )}
        ...
        <div className='flex items-center'>
          <Input
            ...
            className="w-40 rounded-l-xl rounded-r-none border-primary-400 shadow-none border-r-0"
          />
          <Button 
        ...
        <Select 
          ...
          onValueChange={(value) => handleFilterChange("propertytType", value,null)
          }
        >
