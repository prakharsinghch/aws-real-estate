...
import { ArrowDownToLineIcon, Check, CreditCard, Download, Edit, FileText, Mail, MapPin, Table, User } from 'lucide-react';
...
const ResidenceCard = ({
    ...
    return (
        <div className='bg-white rounded-xl shadow-md  overflow-hidden p-6 flex-1 flex-col justify-between'>    
...
const Residence = () => {
    ...
    if(isLoading || leaseLoading || paymentsLoading) return <Loading />

    if(isError || !property) return <div>Error loading residence details</div>
    ...
    <div className='dashboard-container'>
        <div className='w-full mx-auto'>
            <div className='md:flex gap-10'>
                {currentLease && (
                    <ResidenceCard property={property} lease={currentLease}/>
                )}
                {<PaymentMethod />}
            </div>
