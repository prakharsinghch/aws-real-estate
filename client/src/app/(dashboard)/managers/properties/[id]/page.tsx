...
import { useGetAuthUserQuery, useGetManagerPropertiesQuery, useGetPaymentsQuery, useGetPropertiesQuery, useGetPropertyLeasesQuery, useGetPropertyQuery, useGetTenantQuery } from '@/state/api';
...
const PropertyTenants = () => {
  ...
  const { data : property , isLoading: propertyLoading} = useGetPropertyQuery(properyId);
  const { data : leases , isLoading: leasesLoading } = useGetPropertyLeasesQuery(properyId);
  const { data: payments, isLoading: paymentsLoading } = useGetPaymentsQuery(properyId);
