...
import { Lease, Manager, Payment, PaymentStatus, Property, Tenant } from "@/types/prismaTypes";
...
export const api = createApi({
  ...
  updateManagerSetting : build.mutation<Manager, {cognitId: string} & Partial<Manager>>({
...
//Tenants 
  ...
  updateTenantSetting : build.mutation<Tenant, {cognitId: string} & Partial<Tenant>>({
